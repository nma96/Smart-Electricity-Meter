...
import static smartmeter.elexa.R.id.cost;

public class Units extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextViewCost = (TextView)findViewById(R.id.units);
        TextViewUnits = (TextView)findViewById(cost);
     ...
     */
    class SendPostReqAsyncTask1 extends AsyncTask<Void, Void, String> {
        protected String doInBackground(Void... params) {
            try {
                String username = "10";

                String link = "http://smartmeter.000webhostapp.com/phpInsertPayment.php";
                String user = encode("userID", "UTF-8") + "=" +
                        encode(username, "UTF-8");
                String data1 = encode("amount", "UTF-8") + "=" + encode(amount, "UTF-8");
    ...
    public void navigateToBaseActivity(View view) {
        ...
        merchantKey = "gtKFFx";
        TextView retrieveCost = (TextView) findViewById(R.id.cost);
        String amount = retrieveCost.getText().toString();
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Units.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        if (requestCode == PayuConstants.PAYU_REQUEST_CODE) {
            if (data != null) {
                new  SendPostReqAsyncTask1().execute();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.buttonRefresh: onRefresh(v);
                break;
            default:
                break;
        }
    ...
    class SendPostReqAsyncTask extends AsyncTask<Void, Void, String>{
        ...
        String costResult = null;
        StringBuilder sb = new StringBuilder();
        float unitsres ;  float costres;
        @Override
        protected String doInBackground(Void... params) {
            try{
                String userID = "10";
                String link="http://smartmeter.000webhostapp.com/phpFetch2.php";
                String data  = encode("userID", "UTF-8") + "=" + encode(userID, "UTF-8");
                URL url = new URL(link);
                URLConnection conn = url.openConnection();
                ...
                unitResult= sb.toString(); // convert sb to string and store in result
                unitsres = Float.parseFloat(unitResult);
                costres = (float) (unitsres * 0.005); //Conversion
                DecimalFormat df = new DecimalFormat("#.##");
                costResult = df.format(costres);
                amount=costResult;
            }catch(Exception e){
        ...
        protected void onPostExecute(String s) {
            ...
            TextView retrieveUnits = (TextView) findViewById(R.id.units);
            retrieveUnits.setText(unitResult);
            TextView retrieveCost = (TextView) findViewById(R.id.cost);
            retrieveCost.setText(costResult);
        }
    }
}
